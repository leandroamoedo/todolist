...
class TarefasControllerTest < ActionController::TestCase
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post :create, tarefa: { descricao: @tarefa.descricao, inicio: @tarefa.inicio, nome: @tarefa.nome, previsao: @tarefa.previsao, status: @tarefa.status }
    end
  ...
  test "should update tarefa" do
    patch :update, id: @tarefa, tarefa: { descricao: @tarefa.descricao, inicio: @tarefa.inicio, nome: @tarefa.nome, previsao: @tarefa.previsao, status: @tarefa.status }
    assert_redirected_to tarefa_path(assigns(:tarefa))
  end
