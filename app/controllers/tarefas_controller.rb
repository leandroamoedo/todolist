class TarefasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tarefa.save
        format.html { redirect_to @tarefa, notice: 'Tarefa foi criada com sucesso' }
  ...
  def update
    respond_to do |format|
      if @tarefa.update(tarefa_params)
        format.html { redirect_to @tarefa, notice: 'Tarefa foi editada com sucesso' }
  ...
  def destroy
    @tarefa.destroy
    respond_to do |format|
      format.html { redirect_to tarefas_url, notice: 'Tarefa foi excluida com sucesso' }
